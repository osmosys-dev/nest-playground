...
exports.authenticate = exports.findEpisodesForSeason = exports.findSeasonById = exports.findAllSeasons = exports.findAllUsers = exports.EPISODES = exports.SEASONS = exports.USERS = void 0;
exports.USERS = {
    1: {
        id: 1,
...
exports.SEASONS = {
    1: {
        ...
        imageUrl: 'https://m.media-amazon.com/images/M/MV5BMjhiMzgxZTctNDc1Ni00OTIxLTlhMTYtZTA3ZWFkODRkNmE2XkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_SY1000_CR0,0,718,1000_AL_.jpg',
        category: 'ACTION',
        episodesCount: 52,
        seqNo: 1,
        url: 'breaking-bad',
    ...
    2: {
        ...
        imageUrl: 'https://m.media-amazon.com/images/M/MV5BZGQ2YmMxZmEtYjI5OS00NzlkLTlkNTEtYWMyMzkyMzc2MDU5XkEyXkFqcGdeQXVyMzQ2MDI5NjU@._V1_SY1000_CR0,0,666,1000_AL_.jpg',
        category: 'ACTION',
        episodesCount: 5,
        seqNo: 2,
        url: 'chernobyl',
    ...
    4: {
        ...
        imageUrl: 'https://m.media-amazon.com/images/M/MV5BZGJjYzhjYTYtMDBjYy00OWU1LTg5OTYtNmYwOTZmZjE3ZDdhXkEyXkFqcGdeQXVyNTAyODkwOQ@@._V1_SY1000_CR0,0,702,1000_AL_.jpg',
        category: 'COMEDY',
        episodesCount: 90,
        seqNo: 4,
        url: 'the-sopranos',
    ...
    6: {
        ...
        longDescription: "In a war-torn world of elemental magic, a young boy reawakens to undertake a dangerous mystic quest to fulfill his destiny as the Avatar, and bring peace to the world.",
        imageUrl: 'https://m.media-amazon.com/images/M/MV5BNmZlYzIzMTItY2EzYS00YTEyLTg0ZjEtMDMzZjM3ODdhN2UzXkEyXkFqcGdeQXVyNjI0MDg2NzE@._V1_SY1000_CR0,0,666,1000_AL_.jpg',
        category: 'COMEDY',
        episodesCount: 11,
        seqNo: 6,
        url: 'planet-earth',
...
function findAllUsers() {
    return Object.values(exports.USERS);
}
exports.findAllUsers = findAllUsers;
function findAllSeasons() {
    return Object.values(exports.SEASONS);
}
exports.findAllSeasons = findAllSeasons;
function findSeasonById(seasonId) {
    return exports.SEASONS[seasonId];
}
exports.findSeasonById = findSeasonById;
function findEpisodesForSeason(seasonId) {
    return Object.values(exports.EPISODES).filter(function (episode) { return episode.seasonId == seasonId; });
}
exports.findEpisodesForSeason = findEpisodesForSeason;
function authenticate(email, password) {
    var user = Object.values(exports.USERS).find(function (user) { return user.email === email; });
